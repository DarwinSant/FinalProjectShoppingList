package com.DarwinUdacity.ProjectShoppingList.dialog;
...
import com.DarwinUdacity.ProjectShoppingList.utils.Utils;
        ...
        builder.setView(view)
                ...
                .setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int id) {
                        ...
                        inputName = dialog.findViewById(R.id.input_item_name);
                        inputDesc = dialog.findViewById(R.id.input_item_description);
                        inputPrice = dialog.findViewById(R.id.input_item_price);
                        int price = 0;
                        try {
